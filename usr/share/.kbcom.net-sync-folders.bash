...
# create folders and copy folders attribute
 ...
 local LOCAL_ROOTFOLDER_BACKUP="$3"

 LOCAL_SUBFOLDERS_SOURCE=${LOCAL_FILE_SOURCE:${#LOCAL_ROOTFOLDER_SOURCE}}

 LOCAL_SUBFOLDER_SOURCE=${LOCAL_SUBFOLDERS_SOURCE%/*}
 LOCAL_SUBFOLDERS_BACKUP=""

 while LOCAL_SUBFOLDER_SOURCE != ""
 do
  LOCAL_SUBFOLDERS_BACKUP="${LOCAL_SUBFOLDERS_BACKUP}${LOCAL_SUBFOLDER_SOURCE}"

  /bin/mkdir "$LOCAL_ROOTFOLDER_BACKUP/$LOCAL_SUBFOLDERS_BACKUP"
  sync_copy_folderattribute "$LOCAL_ROOTFOLDER_SOURCE/$LOCAL_SUBFOLDERS_BACKUP" "$LOCAL_ROOTFOLDER_BACKUP/$LOCAL_SUBFOLDERS_BACKUP"

  LOCAL_SUBFOLDERS_SOURCE=${LOCAL_SUBFOLDERS_SOURCE:${#LOCAL_SUBFOLDER_SOURCE}}
  LOCAL_SUBFOLDER_SOURCE=${LOCAL_SUBFOLDERS_SOURCE%/*}
 done

 LOCAL_SUBFOLDERS_SOURCE=${LOCAL_FILE_SOURCE:${#LOCAL_ROOTFOLDER_SOURCE}}

 /bin/mkdir "$LOCAL_ROOTFOLDER_BACKUP/$LOCAL_SUBFOLDERS_SOURCE"
 sync_copy_folderattribute "$LOCAL_ROOTFOLDER_SOURCE/$LOCAL_SUBFOLDERS_SOURCE" "$LOCAL_ROOTFOLDER_BACKUP/$LOCAL_SUBFOLDERS_SOURCE"
}
